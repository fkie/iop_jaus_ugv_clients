...
#ifndef ILLUMINATIONCLIENTPLUGIN_H
#define ILLUMINATIONCLIENTPLUGIN_H

#include "urn_jaus_jss_ugv_IlluminationServiceClient/IlluminationServiceClientService.h"
...
class DllExport IlluminationClientPlugin : public PluginInterface
{
public:
	IlluminationClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_ugv_IlluminationServiceClient::IlluminationServiceClientService *p_my_service;
