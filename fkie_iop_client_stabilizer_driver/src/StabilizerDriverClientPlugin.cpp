...
#include "StabilizerDriverClientPlugin.h"

using namespace iop;
using namespace urn_jaus_jss_ugv_StabilizerDriverClient;
...
StabilizerDriverClientPlugin::StabilizerDriverClientPlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* StabilizerDriverClientPlugin::get_service()
{
	return p_my_service;
}

void StabilizerDriverClientPlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new StabilizerDriverClientService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::StabilizerDriverClientPlugin, iop::PluginInterface)
