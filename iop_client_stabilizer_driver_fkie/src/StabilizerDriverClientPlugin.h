...
#ifndef STABILIZERDRIVERCLIENTPLUGIN_H
#define STABILIZERDRIVERCLIENTPLUGIN_H

#include "urn_jaus_jss_ugv_StabilizerDriverClient/StabilizerDriverClientService.h"
...
class DllExport StabilizerDriverClientPlugin : public PluginInterface
{
public:
	StabilizerDriverClientPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_ugv_StabilizerDriverClient::StabilizerDriverClientService *p_my_service;
